...
@section('title', 'Lista de Productos - Gomitas')
...
@section('content')
    ...
    <div class="page-hero">
        <div class="page-hero-inner">
            ...
            <h1>Categoria <span> {{ $categoria->nombre }}</span> {{ $categoria->emoji }}</h1>
            <p>{{ $productos->total() }} diseños imprimibles y editables para cada ocasión.</p>
        </div>
    </div>
        ...
        <aside class="filtros-sidebar">
            ...
            <form method="GET" action="{{ route('productos.index') }}">
                ...
                <div class="filtro-grupo">
                    ...
                    <label>
                        <input type="checkbox" name="tipo[]" value="pdf"
                            {{ in_array('pdf', request('tipo', [])) ? 'checked' : '' }}>
                        PDF imprimible
                    </label>
                    <label>
                        <input type="checkbox" name="tipo[]" value="canva"
                            {{ in_array('canva', request('tipo', [])) ? 'checked' : '' }}>
                        Editable Canva
                    </label>
                    <label>
                        <input type="checkbox" name="tipo[]" value="pptx"
                            {{ in_array('pptx', request('tipo', [])) ? 'checked' : '' }}>
                        PowerPoint
                    </label>
                    <label>
                        <input type="checkbox" name="tipo[]" value="kit"
                            {{ in_array('kit', request('tipo', [])) ? 'checked' : '' }}>
                        Kit completo
                    </label>
                </div>
