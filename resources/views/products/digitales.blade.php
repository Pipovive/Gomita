{{-- resources/views/products/digitales.blade.php --}}
@extends('layouts.app')

@section('title', 'Plantillas Digitales para Fiestas — Descarga Inmediata')

@section('meta')
    <meta name="description"
        content="Plantillas editables en Canva, PDF imprimibles y kits digitales. Descarga inmediata, personaliza en minutos.">
@endsection
